package eu.europeana.mir.web.exception.authentication;
...
public class MirAuthenticationException extends HttpException{
	...
	public MirAuthenticationException(String message, String paramValue){
		this(message, paramValue, null);
	}
	
	public MirAuthenticationException(String message, String paramValue, Throwable th){
		this(message, paramValue, HttpStatus.UNAUTHORIZED, th);
	}

	public MirAuthenticationException(String message, String paramValue, HttpStatus status, Throwable th){
